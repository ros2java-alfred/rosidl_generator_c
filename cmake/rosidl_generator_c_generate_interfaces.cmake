  ...
  if(_extension STREQUAL ".msg")
    if(_parent_folder STREQUAL "msg")
      list(APPEND _generated_msg_headers
        ...
        "${_output_path}/${_parent_folder}/${_header_name}__serialization.h"
      )
      list(APPEND _generated_msg_sources
        "${_output_path}/${_parent_folder}/${_header_name}__functions.c"
        "${_output_path}/${_parent_folder}/${_header_name}__serialization.c"
      )
    else()
...
set(target_dependencies
  ...
  "${rosidl_generator_c_TEMPLATE_DIR}/msg__serialization.h.em"
  "${rosidl_generator_c_TEMPLATE_DIR}/msg__serialization.c.em"
...
if(NOT rosidl_generate_interfaces_DEPENDENCY_PACKAGE_NAMES)
